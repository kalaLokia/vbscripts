...
Sub CLICK_ENTRY_NEW()
    ...
    'Common CCP1
    pxCCP1 = Split("3290,3780,K6044B,GP4304", ",")
    ' pxCCP1 = Worksheets("db_clicking").Range("a3:a20").Value
    'Common CCS
    pxCCS = Split("3391B,3391,DG9133,DG9119,3394", ",")
    ' pxCCS = = Worksheets("db_clicking").Range("b3:b20").value
    'CCP1
    pCCP1 = Split("3791,D4003,8180,3792", ",")
    ' pCCP1 = = Worksheets("db_clicking").Range("c3:c20").value
    'CCF
    pCCF = Split("8170", ",")
    ' pCCF = = Worksheets("db_clicking").Range("e3:e5").value
    'CCS aswell
    pNoCCS = Split("3290,3780,3791,D4003,8180,3391,DG9119,DG9133,3394,DG9540,3250,L2124", ",")
